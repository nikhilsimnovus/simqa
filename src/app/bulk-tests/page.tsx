    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <header className="mb-8 flex items-start justify-between gap-4">
          ...
          <a href="/runs?surface=bulk-validate"
             className="shrink-0 text-sm rounded-md border border-slate-300 px-3 py-2 text-slate-700 hover:bg-slate-50 whitespace-nowrap">
            Past runs →
          </a>
        </header>
